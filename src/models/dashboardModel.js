...
function puxarPontuacaoMediaMinigame(idUsuario) {

    var instrucaoSql = `select round(avg(pontuacaoMinigame)) from tentativaMinigame where fkUsuario = ${idUsuario};`;
